...
module mul_const10_32(input [31:0] a, output [35:0] y);
    // define a input 80.160.255
    // define y output 120.255.160
    wire [35:0] t_3 = {{4{1'b0}}, a} << 3;
    wire [35:0] t_1 = {{4{1'b0}}, a} << 1;
    wire [35:0] s0; wire c0;
    rca36 ad0(.a(t_3),.b(t_1),.cin(1'b0),.sum(s0),.cout(c0));
    assign y = s0;
endmodule
