...
//  square4.v
//  4-bit squarer (a*a).
//  Structural array multiply of a by a; no * operator.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module square4(input [3:0] a, output [7:0] product);
    // define a input 80.160.255   // define product output 120.255.160
    umulcore4 u(.a(a),.b(a),.product(product));
endmodule
