...
module mul_const3_32(input [31:0] a, output [33:0] y);
    // define a input 80.160.255
    // define y output 120.255.160
    wire [33:0] t_1 = {{2{1'b0}}, a} << 1;
    wire [33:0] t_0 = {{2{1'b0}}, a} << 0;
    wire [33:0] s0; wire c0;
    rca34 ad0(.a(t_1),.b(t_0),.cin(1'b0),.sum(s0),.cout(c0));
    assign y = s0;
endmodule

module rca34(input [33:0] a, input [33:0] b, input cin, output [33:0] sum, output cout);
    wire [34:0] c; assign c[0]=cin;
