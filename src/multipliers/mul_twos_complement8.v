// =====================================================================
//  mul_twos_complement8.v
//  8x8 two's-complement signed multiplier.
...
module mul_twos_complement8(input signed [7:0] a, input signed [7:0] b, output signed [15:0] product);
