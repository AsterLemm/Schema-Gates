// =====================================================================
//  mul_booth_radix216.v
//  16x16 radix-2 Booth multiplier (signed).
//  genuine bit-pair Booth recoding: conditional add/subtract of shifted multiplicand; no * operator.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module mul_booth_radix216(input signed [15:0] a, input signed [15:0] b, output signed [31:0] product);
