...
module mul_const3_8(input [7:0] a, output [9:0] y);
    // define a input 80.160.255
    // define y output 120.255.160
    wire [9:0] t_1 = {{2{1'b0}}, a} << 1;
    wire [9:0] t_0 = {{2{1'b0}}, a} << 0;
    wire [9:0] s0; wire c0;
    rca10 ad0(.a(t_1),.b(t_0),.cin(1'b0),.sum(s0),.cout(c0));
    assign y = s0;
endmodule

module rca10(input [9:0] a, input [9:0] b, input cin, output [9:0] sum, output cout);
    wire [10:0] c; assign c[0]=cin;
