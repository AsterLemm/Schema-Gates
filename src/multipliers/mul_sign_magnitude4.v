// =====================================================================
//  mul_sign_magnitude4.v
//  4x4 sign-magnitude multiplier.
...
module mul_sign_magnitude4(input [3:0] a, input [3:0] b, output [7:0] product);
    // define a input 80.160.255   // define b input 80.200.255   // define product output 120.255.160
    wire sgn = a[3] ^ b[3];
    wire [3:0] ma = {1'b0, a[2:0]};
    wire [3:0] mb = {1'b0, b[2:0]};
    wire [7:0] mag;
    smcore4 mm(.a(ma),.b(mb),.product(mag));
    assign product = {sgn, mag[6:0]};
endmodule

module smcore4(input [3:0] a, input [3:0] b, output [7:0] product);
    wire pp0_0 = a[0] & b[0];
    wire pp0_1 = a[1] & b[0];
    wire pp0_2 = a[2] & b[0];
    wire pp0_3 = a[3] & b[0];
