// =====================================================================
//  mac8.v
//  8-bit multiply-accumulate (unsigned).
...
module mac8(input clk, input rst, input en, input [7:0] a, input [7:0] b, output reg [19:0] acc);
    ...
    wire [15:0] prod;
    macmul8 mm(.a(a),.b(b),.product(prod));
    wire [19:0] prod_ext = {{4{1'b0}}, prod};
...
module macmul8(input [7:0] a, input [7:0] b, output [15:0] product);
    wire pp0_0 = a[0] & b[0];
    wire pp0_1 = a[1] & b[0];
    wire pp0_2 = a[2] & b[0];
    wire pp0_3 = a[3] & b[0];
