...
module mul_const5_32(input [31:0] a, output [34:0] y);
    // define a input 80.160.255   // define y output 120.255.160
    wire [34:0] t_2 = {{3{1'b0}}, a} << 2;
    wire [34:0] t_0 = {{3{1'b0}}, a} << 0;
    wire [34:0] s0; wire c0;
    rca35 ad0(.a(t_2),.b(t_0),.cin(1'b0),.sum(s0),.cout(c0));
    assign y = s0;
endmodule

module rca35(input [34:0] a, input [34:0] b, input cin, output [34:0] sum, output cout);
    wire [35:0] c; assign c[0]=cin;
