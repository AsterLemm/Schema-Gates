...
module mul_const5_8(input [7:0] a, output [10:0] y);
    // define a input 80.160.255
    // define y output 120.255.160
    wire [10:0] t_2 = {{3{1'b0}}, a} << 2;
    wire [10:0] t_0 = {{3{1'b0}}, a} << 0;
    wire [10:0] s0; wire c0;
    rca11 ad0(.a(t_2),.b(t_0),.cin(1'b0),.sum(s0),.cout(c0));
    assign y = s0;
endmodule

module rca11(input [10:0] a, input [10:0] b, input cin, output [10:0] sum, output cout);
    wire [11:0] c; assign c[0]=cin;
