...
module mul_const5_16(input [15:0] a, output [18:0] y);
    // define a input 80.160.255   // define y output 120.255.160
    wire [18:0] t_2 = {{3{1'b0}}, a} << 2;
    wire [18:0] t_0 = {{3{1'b0}}, a} << 0;
    wire [18:0] s0; wire c0;
    rca19 ad0(.a(t_2),.b(t_0),.cin(1'b0),.sum(s0),.cout(c0));
    assign y = s0;
endmodule

module rca19(input [18:0] a, input [18:0] b, input cin, output [18:0] sum, output cout);
    wire [19:0] c; assign c[0]=cin;
