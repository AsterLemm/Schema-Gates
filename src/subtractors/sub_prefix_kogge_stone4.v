// =====================================================================
//  sub_prefix_kogge_stone4.v
//  4-bit subtractor (two's complement on Kogge-Stone prefix adder).
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module sub_prefix_kogge_stone4(input [3:0] a, input [3:0] b, output [3:0] diff, output bout);
    // define a input 80.160.255
    // define b input 80.200.255
    // define diff output 120.255.160
    // define bout output 255.120.120
    wire cout; ks_unit4 u(.a(a),.b(~b),.cin(1'b1),.sum(diff),.cout(cout));
    assign bout=~cout;
endmodule

module ks_unit4(input [3:0] a, input [3:0] b, input cin, output [3:0] sum, output cout);
    wire [3:0] p0,g0;
