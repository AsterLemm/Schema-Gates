// =====================================================================
//  sub_cskip8.v
//  8-bit subtractor (two's complement on carry-skip adder).
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module sub_cskip8(input [7:0] a, input [7:0] b, output [7:0] diff, output bout);
    // define a input 80.160.255   // define b input 80.200.255   // define diff output 120.255.160   // define bout output 255.120.120
    wire cout; addskip_unit8 u(.a(a),.b(~b),.cin(1'b1),.sum(diff),.cout(cout));
    assign bout=~cout;
endmodule

module addskip_unit8(input [7:0] a, input [7:0] b, input cin, output [7:0] sum, output cout);
