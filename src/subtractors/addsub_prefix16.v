// =====================================================================
//  addsub_prefix16.v
//  16-bit add/sub on Kogge-Stone prefix adder.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module addsub_prefix16(input [15:0] a, input [15:0] b, input sub, output [15:0] result, output cout, output ovf);
    ...
    wire [15:0] bx=b^{16{sub}}; wire co;
    ksadd16 u(.a(a),.b(bx),.cin(sub),.sum(result),.cout(co));
    assign cout=co; assign ovf=(a[15]==bx[15])&(result[15]!=a[15]);
endmodule

module ksadd16(input [15:0] a, input [15:0] b, input cin, output [15:0] sum, output cout);
    wire [15:0] p0,g0;
