// =====================================================================
//  add_cla8.v
//  8-bit CLA: 2 x cla4 blocks + group lookahead.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module add_cla8(input [7:0] a, input [7:0] b, input cin, output [7:0] sum, output cout);
    ...
    wire [1:0] gp, gg;
    wire [2:0] carry; assign carry[0]=cin;
