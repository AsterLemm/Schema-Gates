// =====================================================================
//  add_cskip8.v
//  8-bit carry-skip: 4-bit ripple blocks, carry skips fully-propagating blocks.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module add_cskip8(input [7:0] a, input [7:0] b, input cin, output [7:0] sum, output cout);
