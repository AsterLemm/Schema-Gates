// =====================================================================
//  add_serial8.v
//  8-bit bit-serial adder (1 full-adder + carry FF, 8 clocks).
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module add_serial8(input clk, input rst, input start, input [7:0] a, input [7:0] b, output reg [7:0] sum, output reg cout, output reg done);
    ...
    always @(posedge clk) begin
        if (rst) begin idx<=0; carry<=0; sum<=0; cout<=0; done<=0; end
            ...
            if (idx == 7) begin cout <= bit_carry; done <= 1'b1; end
            else idx <= idx + 1'b1;
        end
    end
endmodule
