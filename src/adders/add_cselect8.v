// =====================================================================
//  add_cselect8.v
//  8-bit carry-select: each 4-bit block computed for cin=0 and 1, then muxed.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module add_cselect8(input [7:0] a, input [7:0] b, input cin, output [7:0] sum, output cout);
