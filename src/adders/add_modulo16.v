// =====================================================================
//  add_modulo16.v
//  16-bit modulo-2^16 adder (carry-out discarded).
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module add_modulo16(input [15:0] a, input [15:0] b, input cin, output [15:0] sum);
    // define a input 80.160.255   // define b input 80.200.255   // define cin input 255.230.80   // define sum output 120.255.160
