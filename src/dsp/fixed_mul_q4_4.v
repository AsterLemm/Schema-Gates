// =====================================================================
//  fixed_mul_q4_4.v
//  Q4.4 fixed-point multiply (8-bit, rescaled).
//  Structural signed multiply + arithmetic shift; no * operator.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module fixed_mul_q4_4(input signed [7:0] a, input signed [7:0] b, output signed [7:0] y);
    // define a input 80.160.255   // define b input 80.200.255   // define y output 120.255.160
    wire signed [15:0] full;
    fmsmul8 mm(.a(a),.b(b),.product(full));
    assign y = full >>> 4;   // rescale by fractional bits (arith shift)
endmodule

module fmsmul8(input signed [7:0] a, input signed [7:0] b, output signed [15:0] product);
    wire sa=a[7], sb=b[7];
