// =====================================================================
//  sqrt_comb8.v
//  8-bit integer square root (structural digit-by-digit non-restoring array).
...
module sqrt_comb8(input [7:0] a, output [3:0] root, output [4:0] remainder, output valid, output busy, output done);
    ...
    sqcore8 c(.a(a), .root(rt), .rem(rm));
    assign root = rt; assign remainder = rm;
    assign valid=1'b1; assign busy=1'b0; assign done=1'b1;
endmodule

module sqcore8(input [7:0] a, output [3:0] root, output [4:0] rem);
