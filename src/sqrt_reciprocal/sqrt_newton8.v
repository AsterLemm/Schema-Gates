// =====================================================================
//  sqrt_newton8.v
//  8-bit Newton's-method square root.
...
module sqrt_newton8(input [7:0] a, output [3:0] root, output valid);
    // define a input 80.160.255   // define root output 120.255.160   // define valid output 255.255.255
    wire [3:0] rt; wire [4:0] rm;
    sqcore8 c(.a(a), .root(rt), .rem(rm));
    assign root = rt; assign valid=1'b1;
endmodule
