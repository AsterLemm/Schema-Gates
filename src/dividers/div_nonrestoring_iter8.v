// =====================================================================
//  div_nonrestoring_iter8.v
//  8-bit iterative non-restoring divider (8 cycles).
...
module div_nonrestoring_iter8(input clk, input rst, input start, input [7:0] a, input [7:0] b,
