// =====================================================================
//  reciprocal_lut8.v
//  8-bit reciprocal (structural division of (2^8-1) by a); no / or % operator.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module reciprocal_lut8(input [7:0] a, output [7:0] recip, output valid);
    // define a input 80.160.255
    // define recip output 120.255.160
    ...
    recipcore8 dv(.a(num),.b(a),.quotient(q),.remainder(r),.divide_by_zero(d2),.overflow(o2),.valid(v2),.busy(b2),.done(dn2));
    assign recip = dz ? {8{1'b1}} : q;
endmodule

module recipcore8(input [7:0] a, input [7:0] b,
