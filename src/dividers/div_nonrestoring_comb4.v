// =====================================================================
//  div_nonrestoring_comb4.v
//  4-bit non-restoring division (realized as the restoring shift/subtract array).
...
module div_nonrestoring_comb4(input [3:0] a, input [3:0] b,
