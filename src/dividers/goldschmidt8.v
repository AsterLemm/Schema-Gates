// =====================================================================
//  goldschmidt8.v
//  8-bit Goldschmidt divider (result via structural restoring array); no / or % operator.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module goldschmidt8(input [7:0] a, input [7:0] b, output [7:0] quotient, output valid);
    ...
    goldschmidtcore8 dv(.a(a),.b(b),.quotient(q),.remainder(r),.divide_by_zero(d2),.overflow(o2),.valid(v2),.busy(b2),.done(dn2));
    assign quotient = dz ? {8{1'b1}} : q;
endmodule

module goldschmidtcore8(input [7:0] a, input [7:0] b,
