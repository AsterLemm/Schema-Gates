// =====================================================================
//  div_nonrestoring_comb8.v
//  8-bit non-restoring division (realized as the restoring shift/subtract array).
...
module div_nonrestoring_comb8(input [7:0] a, input [7:0] b,
