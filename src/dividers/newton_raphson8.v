// =====================================================================
//  newton_raphson8.v
//  8-bit Newton-Raphson divider (result via structural restoring array); no / or % operator.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module newton_raphson8(input [7:0] a, input [7:0] b, output [7:0] quotient, output valid);
    // define a input 80.160.255   // define b input 80.200.255   // define quotient output 120.255.160
    wire dz=~(|b); assign valid=~dz;
    wire [7:0] q, r; wire d2,o2,v2,b2,dn2;
    newton_raphsoncore8 dv(.a(a),.b(b),.quotient(q),.remainder(r),.divide_by_zero(d2),.overflow(o2),.valid(v2),.busy(b2),.done(dn2));
    assign quotient = dz ? {8{1'b1}} : q;
endmodule

module newton_raphsoncore8(input [7:0] a, input [7:0] b,
