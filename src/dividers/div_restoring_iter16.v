// =====================================================================
//  div_restoring_iter16.v
//  16-bit iterative restoring divider (16 cycles).
...
module div_restoring_iter16(input clk, input rst, input start, input [15:0] a, input [15:0] b,
