// =====================================================================
//  newton_raphson4.v
//  4-bit Newton-Raphson divider (result via structural restoring array); no / or % operator.
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module newton_raphson4(input [3:0] a, input [3:0] b, output [3:0] quotient, output valid);
    ...
    newton_raphsoncore4 dv(.a(a),.b(b),.quotient(q),.remainder(r),.divide_by_zero(d2),.overflow(o2),.valid(v2),.busy(b2),.done(dn2));
    assign quotient = dz ? {4{1'b1}} : q;
endmodule

module newton_raphsoncore4(input [3:0] a, input [3:0] b,
