// =====================================================================
//  fp8_compare.v
//  fp8 ordered comparator (sign-magnitude semantics).
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module fp8_compare(input [7:0] a, input [7:0] b, output lt, output eq, output gt);
    // define a input 80.160.255   // define b input 80.200.255   // define lt output 255.255.255   // define eq output 255.255.255   // define gt output 255.255.255
    wire sa=a[7], sb=b[7];
