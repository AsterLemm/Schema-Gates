...
module timer16(input clk, input rst, input en, input [15:0] period, output reg [15:0] count, output expired);
    ...
    always @(posedge clk) if (rst) count<=16'b0; else if (en) count <= expired ? 16'b0 : count+1'b1;
endmodule
