...
module timer8(input clk, input rst, input en, input [7:0] period, output reg [7:0] count, output expired);
    ...
    always @(posedge clk) if (rst) count<=8'b0; else if (en) count <= expired ? 8'b0 : count+1'b1;
endmodule
