// =====================================================================
//  bcd_add4.v
//  4-digit BCD adder (+6 decimal correction).
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module bcd_add4(input [15:0] a, input [15:0] b, input cin, output [15:0] sum, output cout);
    ...
    wire [4:0] dc; assign dc[0]=cin;   // decimal carries
