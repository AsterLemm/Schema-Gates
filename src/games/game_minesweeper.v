...
module game_minesweeper (
  ...
  function [8:0] dots;
    ...
    begin
      case (n)
      4'd1: dots = 9'b000010000;
      4'd2: dots = 9'b100000001;
      4'd3: dots = 9'b100010001;
      4'd4: dots = 9'b101000101;
      4'd5: dots = 9'b101010101;
      4'd6: dots = 9'b101101101;
      4'd7: dots = 9'b101111101;
      4'd8: dots = 9'b111101111;
