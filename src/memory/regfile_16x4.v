// =====================================================================
//  regfile_16x4.v
//  16x4 register file (1W/2R).
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module regfile_16x4(input clk, input we, input [3:0] waddr, input [3:0] wdata,
    input [3:0] raddr_a, input [3:0] raddr_b, output [3:0] rdata_a, output [3:0] rdata_b);
    ...
    // 16x4 register file, 1 write / 2 read ports (64 bits).
    reg [3:0] regs [0:15];
