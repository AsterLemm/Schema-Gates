// =====================================================================
//  regfile_8x16.v
//  8x16 register file (1W/2R).
//  Part of schema-gates by BITFries.
//  Self-contained: embeds every submodule it uses, down to leaf gates.
//  Target synthesizer: BITF-Synthesis Engine (Verilog -> SchemaGates).
// =====================================================================

module regfile_8x16(input clk, input we, input [2:0] waddr, input [15:0] wdata,
    input [2:0] raddr_a, input [2:0] raddr_b, output [15:0] rdata_a, output [15:0] rdata_b);
    ...
    // 8x16 register file, 1 write / 2 read ports (128 bits).
    reg [15:0] regs [0:7];
