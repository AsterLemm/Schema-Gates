// =====================================================================
//  interp_fetch_switch16.v
//  INTERPRETER GLUE: A/B switch on a 16-bit host instruction-fetch port.
//
...
//
//  For 32-bit-instruction hosts (the ARM family) use the _32 variant.
//
...
// --- interp_fetch_switch16_imux : the A/B instruction-stream switch ---
module interp_fetch_switch16_imux(
    input  wire        mode,
    input  wire [15:0] native_instr,
    input  wire [15:0] xlat_instr,
    output wire [15:0] host_instr
);
    assign host_instr = mode ? xlat_instr : native_instr;
endmodule

// --- interp_fetch_switch16_trapgate : believe trap only in interpreter mode ---
module interp_fetch_switch16_trapgate(
    input  wire mode,
