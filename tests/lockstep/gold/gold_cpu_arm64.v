...
module gold_cpu_arm64(
    ...
    wire [63:0] ar_y = adS[63:0];
    wire ar_c = adS[64];                 // ARM: C = NOT borrow on subtract
    wire ar_v = (adA[63] == adB[63]) & (ar_y[63] != adA[63]);
    ...
    wire [63:0] dp_y = sel_arith ? ar_y : lg_y;
