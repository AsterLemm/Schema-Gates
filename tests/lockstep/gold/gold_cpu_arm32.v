...
module gold_cpu_arm32(
    ...
    wire [31:0] ar_y = adS[31:0];
    wire ar_c = adS[32];                 // ARM: C = NOT borrow on subtract
    wire ar_v = (adA[31] == adB[31]) & (ar_y[31] != adA[31]);
    ...
    wire [31:0] dp_y = sel_arith ? ar_y : lg_y;
