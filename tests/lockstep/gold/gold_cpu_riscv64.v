...
module gold_cpu_riscv64(
    ...
    wire [63:0] rs1v = (rs1 == 4'd0) ? {64{1'b0}} : x[rs1];
    wire [63:0] rs2v = (rs2 == 4'd0) ? {64{1'b0}} : x[rs2];
    ...
    wire [63:0] log_y = (lsel == 2'd0) ? (log_a & log_b)
    ...
    wire [63:0] shf_y = (funct == 4'd5) ? (shf_a <<  shf_n)
    ...
    wire [63:0] load_v = dmem[alu_y[3:0]];
    wire [63:0] pcret  = {{56{1'b0}}, pc1};
    wire [63:0] wb_val = is_lui          ? {imm16, {48{1'b0}}}
                          : is_load          ? load_v
