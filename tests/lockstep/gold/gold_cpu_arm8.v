...
module gold_cpu_arm8(
    ...
    wire [7:0] ar_y = adS[7:0];
    wire ar_c = adS[8];                 // ARM: C = NOT borrow on subtract
    wire ar_v = (adA[7] == adB[7]) & (ar_y[7] != adA[7]);
    ...
    wire [7:0] dp_y = sel_arith ? ar_y : lg_y;
