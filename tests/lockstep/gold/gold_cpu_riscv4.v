...
module gold_cpu_riscv4(
    ...
    wire [3:0] rs1v = (rs1 == 4'd0) ? {4{1'b0}} : x[rs1];
    wire [3:0] rs2v = (rs2 == 4'd0) ? {4{1'b0}} : x[rs2];
    ...
    wire [3:0] log_y = (lsel == 2'd0) ? (log_a & log_b)
    ...
    wire [3:0] shf_y = (funct == 4'd5) ? (shf_a <<  shf_n)
    ...
    wire [3:0] load_v = dmem[alu_y[3:0]];
    wire [3:0] pcret  = pc1[3:0];
    wire [3:0] wb_val = is_lui          ? imm16[3:0]
                          : is_load          ? load_v
