...
module gold_cpu_riscv32(
    ...
    wire [31:0] rs1v = (rs1 == 4'd0) ? {32{1'b0}} : x[rs1];
    wire [31:0] rs2v = (rs2 == 4'd0) ? {32{1'b0}} : x[rs2];
    ...
    wire [31:0] log_y = (lsel == 2'd0) ? (log_a & log_b)
    ...
    wire [31:0] shf_y = (funct == 4'd5) ? (shf_a <<  shf_n)
    ...
    wire [31:0] load_v = dmem[alu_y[3:0]];
    wire [31:0] pcret  = {{24{1'b0}}, pc1};
    wire [31:0] wb_val = is_lui          ? {imm16, {16{1'b0}}}
                          : is_load          ? load_v
