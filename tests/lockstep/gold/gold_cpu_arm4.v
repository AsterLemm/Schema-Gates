...
module gold_cpu_arm4(
    ...
    wire [3:0] ar_y = adS[3:0];
    wire ar_c = adS[4];                 // ARM: C = NOT borrow on subtract
    wire ar_v = (adA[3] == adB[3]) & (ar_y[3] != adA[3]);
    ...
    wire [3:0] dp_y = sel_arith ? ar_y : lg_y;
